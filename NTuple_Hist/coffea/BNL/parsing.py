    ...
    def parsing_rucio(self, l, sti=0, eti=12, psi=1):
        with open(l, 'r') as f:
            if f:
                ...
                start_date_time = dt.datetime(int(start_list[0][0:4]), int(start_list[0][5:7]), int(start_list[0][8:10]), int(start_list[1][0:2]), int(start_list[1][3:5]), int(start_list[1][6:8]))
                end_date_time = dt.datetime(int(end_list[0][0:4]), int(end_list[0][5:7]), int(end_list[0][8:10]), int(end_list[1][0:2]), int(end_list[1][3:5]), int(end_list[1][6:8]))
