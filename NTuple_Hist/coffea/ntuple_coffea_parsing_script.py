...
af_location = ""  # TODO: Set the AF location (e.g., 'uc', 'slac', 'bnl')
...
def main():
    ...
    list_of_data_tuples = []
    for log_path in list_of_full_path:
        list_of_data_tuples.append(parsing_function(log_path))
