...
source ${ATLAS_LOCAL_ROOT_BASE}/user/atlasLocalSetup.sh -c el9 -m /data/ -r "python3 /home/$(whoami)/AF-Benchmarking/NTuple_Hist/coffea/UC/example.py  2>&1 | tee coffea_hist.log"
