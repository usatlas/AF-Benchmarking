...
source ${ATLAS_LOCAL_ROOT_BASE}/user/atlasLocalSetup.sh -c el9 -m /data/ -r " python3 --version >> /home/selbor/python3_version.txt"
#source ${ATLAS_LOCAL_ROOT_BASE}/user/atlasLocalSetup.sh -c el9 -m /data/ -r "source /data/selbor/ntuple_hist/bin/activate
