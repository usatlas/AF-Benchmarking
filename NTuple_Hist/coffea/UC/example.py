...
def main():
    ...
    with Client(cluster) as client:
        dataset_runnable = json.loads(Path("/home/runner/_work/af-benchmarking/af-benchmarking/coffea/single_campaign_mc20e_dataset_runnable/af_v2_700402.json").read_text())
        nevents=0
