...
for l in full_path_list:
    try:
        ...
        list_dics.append(parsing.parsing_truth3_slac_e1(l, os_used="centos", container=True, batch=True))
    except ValueError:
       list_dics.append(parsing.parsing_truth3_log_split(l, os_used="centos", container=True, batch=True))
