    ...
    def parsing_rucio(self, log_path, sti=0, eti=12, psi=1):
        with open(log_path) as f:
            if f:
                ...
                start_list = (first_line.split("\x1b[32;1m")[1].split(",")[0]).split(
                    " "
                )
                if N == 113:
                    exit_code = 0
                    last_line = file_lines[N - 12]
                    end_list = (last_line.split("\x1b[32;1m")[1].split(",")[0]).split(
                        " "
                    )
                else:
                    exit_code = 1
                    last_line = file_lines[N - 3]
                    end_list = (last_line.split("\x1b[31;1m")[1].split(",")[0]).split(
                        " "
                    )
                ...
                start_date_time = dt.datetime(
                    int(start_list[0][0:4]),
                    int(start_list[0][5:7]),
                    int(start_list[0][8:10]),
                    int(start_list[1][0:2]),
                    int(start_list[1][3:5]),
                    int(start_list[1][6:8]),
                )
