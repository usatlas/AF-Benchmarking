...
output_dir="/home/$USER/benchmarks/${curr_time}/TRUTH3_el9_container_interactive"
...
cleanup_dir="/home/selbor/TRUTH3Job/el9_i"

if [[ -d "${cleanup_dir}" && "${cleanup_dir}" == "/home/selbor/TRUTH3Job/el9_i" ]]; then
    rm -rf "${cleanup_dir:?}/"*
fi
