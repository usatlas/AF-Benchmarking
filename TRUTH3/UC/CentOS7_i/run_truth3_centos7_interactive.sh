...
output_dir="/home/$USER/benchmarks/${curr_time}/TRUTH3_centos_interactive/"
...
cleanup_dir="/home/selbor/TRUTH3Job/centos7_i"

if [[ -d "${cleanup_dir}" && "${cleanup_dir}" == "/home/selbor/TRUTH3Job/centos7_i" ]]; then
    rm -rf "${cleanup_dir:?}/"*
fi
